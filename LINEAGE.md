...
offscreen-document recording pattern were informed by that earlier work,
but this codebase shares none of its source text. This file is the only
place in the repository where the prior project's name appears.
